        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          <div className="lg:col-span-2">
            <div data-aos="fade-right" className="bg-white/80 backdrop-blur-xs border border-slate-100 rounded-2xl shadow-sm p-5 md:p-7">
              ...
              {/* การ์ดบริการ — อ่านจาก QUICK_LINKS ที่เดียวกับแถบลิงก์ด่วนและป้ายฟีเจอร์
                  ...
                  ปุ่มกลุ่ม "ของฉัน" เคยเป็น grid แยกอยู่ในบัตรนักเรียนด้านบน ใช้ gap-2
                  แล้วเว้น mt-6 ก่อนถึงกริดนี้ที่ใช้ gap-3 — ตอนล็อกอินแล้วจึงเห็นช่องว่าง
                  สามค่าซ้อนกันในสิ่งที่ดูเหมือนตารางเดียว รวมเป็นกริดเดียวไปเลย
                  ช่องว่างทุกช่องจึงเท่ากัน และลำดับยังเป็นของฉันก่อนบริการเหมือนเดิม */}
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[...myLinks, ...features].map(l => <LinkCard key={l.name} link={l} />)}
              </div>
            </div>
          </div>
